...
const footer=(props)=> (
    <Segment  >
      <Container> 
        <Menu secondary='true' >
         <Menu.Item>
            <h1>Workers Requirement</h1>
        </Menu.Item>
         </Menu>    
  
        <div class="ui form">
          <div class="inline fields">
            <h3>Require Master Workers</h3><div class="field"></div>
 ...
 {/* value={props.value} */}
        ...
        <div class="ui labeled input">
          <div class="ui label"><h3>Reward per Response</h3> </div>
        ...
        <Menu.Item>
        <div class="ui labeled input">
          <div class="ui label"><h3>Number of Workers</h3> </div>
